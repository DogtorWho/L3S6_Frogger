...
user in an INI file next to eclipse.exe called eclipse.ini.
...
copy AppNamePortable.ini from this directory to eclipse.ini next to
eclipse.exe. The options in the INI file are as follows:
